...
AutoDiscovery.prototype.startDelayed = function (dockerEvent, containerInfo) {
  // handle events with 1 second delay to wait for POD IP on Kuberntes
  setTimeout(function () {
    this.start(dockerEvent, containerInfo)
  }.bind(this), 5000)
}
